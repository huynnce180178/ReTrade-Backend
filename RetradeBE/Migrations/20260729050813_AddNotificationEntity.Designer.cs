...
namespace RetradeBE.Migrations
{
    ...
    [Migration("20260729050813_AddNotificationEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetradeBE.Models.Chat", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedAt" }, "idx_chat_created_at");

                    b.HasIndex(new[] { "IsRead" }, "idx_chat_is_read");

                    b.HasIndex(new[] { "RoomId", "CreatedAt" }, "idx_chat_room_created_at");

                    b.HasIndex(new[] { "RoomId" }, "idx_chat_room_id");

                    b.HasIndex(new[] { "RoomId", "IsRead" }, "idx_chat_room_is_read");

                    b.ToTable("chat", (string)null);
                });

            modelBuilder.Entity("RetradeBE.Models.ChatMessage", b =>
                {
                    ...
                    b.Property<string>("FunctionCallId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.HasIndex(new[] { "CreatedAt" }, "idx_chat_message_created_at");

                    b.HasIndex(new[] { "SessionId", "CreatedAt" }, "idx_chat_message_session_created_at");

                    b.HasIndex(new[] { "SessionId" }, "idx_chat_message_session_id");
            ...
            modelBuilder.Entity("RetradeBE.Models.ChatSession", b =>
                {
                    b.Property<string>("SessionId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.HasKey("SessionId")
                        .HasName("chat_session_pkey");

                    b.HasIndex(new[] { "IsActive" }, "idx_chat_session_is_active");

                    b.HasIndex(new[] { "UserId" }, "idx_chat_session_user_id");
            ...
            modelBuilder.Entity("RetradeBE.Models.Notification", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId", "IsRead" }, "idx_notification_user_is_read");
            ...
            modelBuilder.Entity("RetradeBE.Models.ChatMessage", b =>
                {
                    b.HasOne("RetradeBE.Models.ChatSession", "Session")
