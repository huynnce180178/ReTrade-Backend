sequenceDiagram
    ...
    User->>Page: 1. Click on unread notification
    Page->>Hub: 2. Invoke MarkAsRead(notificationId) via SignalR
    
    Hub->>Hub: Get accountId from Context
    
    Hub->>Svc: 3. MarkAsReadAsync(accountId, notificationId)
    ...
    alt Account invalid
        ...
        alt Notification valid
            ...
            Page-->>User: 8.2.11. Visually mark notification as read
